...
namespace SimpleShoppingList.Controllers
{
    public class ShoppingListController : ApiController
    {
        ...
        {
            new ShoppingList() { Id = 0, Name = "Owoce", Items = {
                    new Item { Id = 0, Name = "Banany", ShoppingListId = 0 },
                    new Item { Id = 1, Name = "Maliny", ShoppingListId = 0 },
                    new Item { Id = 2, Name = "Jabłka", ShoppingListId = 0 }
                }
            },
            new ShoppingList() { Id = 1, Name = "Obiady" }
        };
